const About = () => {
    return (
        <>
            <div id="" className="bg-primary dark:bg-darkPrimary flex justify-center pt-12 pb-12 ">
                <div className="max-w-2xl pr-5 pl-5">
                    <p className="text-3xl font-bold mb-10 dark:text-darkTextPrimary">About me</p>
                    ...
                    <p className="text-sm sm:text-base mb-5 text-textSecondary">Do you want to get in contact with me? Contact me on <a href="mailto:contact@limpan.dev" className="text-black dark:text-textPrimary">contact@limpan.dev</a> or on discord <a href="https://discord.com/users/322015089529978880" className="text-black dark:text-textPrimary">B1NUS#1994</a></p>
